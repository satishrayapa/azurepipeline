DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = 'a2b51265-9156-4784-b829-8407e4904119';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US CPSC';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Consumer Product Safety Commission regulations for US products';

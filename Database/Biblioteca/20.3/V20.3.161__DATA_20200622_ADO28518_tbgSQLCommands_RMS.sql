DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = '7b8c07ad-7a1b-4baf-a2fa-3b124e3b8e4a';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US ATF';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Alcohol Tobacco, Firearms and Explosives Bureau regulations for US products';

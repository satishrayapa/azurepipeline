DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = '84db6e93-12d9-4439-bf03-b0794f887154';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US CBP';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Customs and Border Protection regulations for US products';

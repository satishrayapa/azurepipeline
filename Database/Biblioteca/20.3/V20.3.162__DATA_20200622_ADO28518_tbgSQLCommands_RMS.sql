DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = '9e3f9f6c-bf4e-4366-91ff-b40801d4c6a3';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US FWS';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Fish and Wildlife Service regulations for US products';

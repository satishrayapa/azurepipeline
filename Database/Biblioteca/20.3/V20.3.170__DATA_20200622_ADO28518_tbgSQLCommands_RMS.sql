DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = '9b51e137-f4f0-4bc0-b3bd-4fa01e238546';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US FTC';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Federal Trade Commission regulations for US products';

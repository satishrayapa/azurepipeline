DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = '6dcc8243-61eb-408d-984a-fa41bb50f699';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US USDA';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Department of Agriculture regulations for US products';

DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = 'a58e745d-3ee5-4844-99a4-2efe92d09bbc';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US FCC';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Federal Communications Commission regulations for US products';

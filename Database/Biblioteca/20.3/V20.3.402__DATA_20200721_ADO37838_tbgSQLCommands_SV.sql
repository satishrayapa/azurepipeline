DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = '7b7dc548-b62b-4c55-bcde-675e2ba72876';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'DPS Lookup: Blocked Parties';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays all parties that have a status of Blocked';

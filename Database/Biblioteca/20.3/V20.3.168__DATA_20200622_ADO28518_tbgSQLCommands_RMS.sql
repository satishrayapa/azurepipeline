DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = 'ddbfc1d7-60f6-4b4a-bb65-e817e862589e';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US EPA';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Environmental Protection Agency regulations for US products';

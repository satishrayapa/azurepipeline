DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = 'f159dd37-3136-4920-9d7f-59db7d124881';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US FDA';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Food & Drug regulations for US products';

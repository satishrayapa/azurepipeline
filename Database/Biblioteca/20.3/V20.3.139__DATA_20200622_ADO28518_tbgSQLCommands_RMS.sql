DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = '81bd01d0-49de-493e-96f3-a721bb07ec43';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Request Lookup: High Priority Requests';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays classification requests that have been marked "High Priority."';

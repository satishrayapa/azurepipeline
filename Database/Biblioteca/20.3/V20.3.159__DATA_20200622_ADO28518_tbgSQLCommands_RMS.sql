DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = 'cdf311ae-9151-4cc6-ad1b-62b93158ba63';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US DOT';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Department of Transportation regulations for US products';

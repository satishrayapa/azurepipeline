DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = 'd0b5bfe6-8214-4143-9785-f9e399a96ca5';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US WHO';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US  WHO regulations for US products';

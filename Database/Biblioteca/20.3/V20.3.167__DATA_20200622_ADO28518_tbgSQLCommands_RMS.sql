DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = '22fa5110-38ae-4b61-9a41-c0ae405744b9';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US NMFS';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US National Marine Fisheries Service regulations for US products';

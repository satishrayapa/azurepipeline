DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = 'c36b1fe2-e71e-42db-a495-321776e02818';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US APHIS';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Animal & Plant Health Inspection Service regulations for US products';

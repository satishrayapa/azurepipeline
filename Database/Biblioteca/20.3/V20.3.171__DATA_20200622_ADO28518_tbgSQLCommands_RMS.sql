DECLARE @CurrentSQLGuid1 AS VARCHAR(36) = 'e90ccfa8-ab73-493f-8813-93b4ac4fe614';
DECLARE @CurrentSQLDescription1 AS NVARCHAR(500) = 'Classification Lookup: CI - US DOL';
DECLARE @CurrentSQLLongDescription1 AS NVARCHAR(MAX) = 'Displays the US Department of Labor regulations for US products';

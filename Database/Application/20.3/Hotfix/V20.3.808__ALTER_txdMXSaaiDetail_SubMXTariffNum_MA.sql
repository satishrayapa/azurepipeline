...
IF EXISTS (SELECT TOP 1 1 FROM sys.columns WHERE name = 'SubMXTariffNum' --your column here
...
BEGIN
	...
	EXEC usp_DBACopyTableIndexesByColumn '','txdMXSaaiDetail','SubMXTariffNum','varchar',1,2

	ALTER TABLE txdMXSaaiDetail --Your Table Here
	ALTER COLUMN SubMXTariffNum [varchar] (2) NOT NULL --your column here

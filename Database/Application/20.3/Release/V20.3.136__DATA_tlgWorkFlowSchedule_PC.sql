...
'PTR3SpreadSheetUploadReconciliationPCDetail' as Description,
'N' AS Recurring, 
'00:00' AS Time,
GETDATE() AS Date,
...
WHERE
    NOT EXISTS (select * from tlgWorkFlowSchedule where PartnerID = @partnerid and Workflow = 'PTR3SpreadSheetUploadReconciliationPCDetail')

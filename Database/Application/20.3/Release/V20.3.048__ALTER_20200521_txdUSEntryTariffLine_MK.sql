...
DECLARE @indexPrefix varchar(60) = 'IX_txdUSEntryTariffLine_'
DECLARE @table varchar(60) = 'dbo.txdUSEntryTariffLine'
DECLARE @indexColumns varchar(800) = 'EntryGUID,PartnerID' --can include DESC
DECLARE @includedColumns varchar(800) = 'TariffLineNum,Duty'

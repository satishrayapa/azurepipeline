IF EXISTS (select TOP 1 1 from sys.tables where Name = 'usrtxdCNHandbookPCDetail'
			AND Type = 'U')
BEGIN	
...
ELSE
BEGIN
	CREATE TABLE [dbo].[usrtxdCNHandbookPCDetail]
	(
		 PartnerId INT
		...
		,SubMaterialMarkCode NVARCHAR(4000)
		,EnterpriseExecuteMarkCode NVARCHAR(4000)
		,ModifyMarkCode NVARCHAR(4000)
		,ApprovedMaxRemainQty NVARCHAR(4000)

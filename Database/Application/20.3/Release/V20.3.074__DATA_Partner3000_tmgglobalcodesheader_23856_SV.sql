...
BEGIN  
	...
	VALUES ('3000',GETDATE(),'DPS','DPS Company Screening Status Override Options used to classify the reason a company status was overriden','OverRideReasonCode','Y','N','N'),
					   ...
					   ('3000',GETDATE(),'IMMEX','MX país de origen del pedimento en Data Stage / MX Data Stage country of origin field for customs declarations','DATASTAGEOPTCTYORIG','Y','N','N'),
					   ...
					   ('3000',GETDATE(),'IMMEX','MX indicador para cuándo se encontró el pedimento en Data Stage / MX Data Stage flag to indicate when customs declarations was found','DATASTAGEOPTPED','Y','N','N'),
					   ...
					   ('3000',GETDATE(),'IMMEX','MX valor en dólares de la partida en Data Stage / MX Data Stage dollar value for customs declarations item','DATASTAGEOPTUSVALD','Y','N','N'),
					   ('3000',GETDATE(),'IMMEX','MX valor total en dólares del pedimento en Data Stage / MX Data Stage total dollar value for customs declarations','DATASTAGEOPTUSVALT','Y','N','N'),
					   ('3000',GETDATE(),'IMMEX','MX clave del pedimento de exportación / MX Export customs declaration type','ExportPedimentoCode','Y','N','N'),
					   ('3000',GETDATE(),'IMMEX','MX tipo de factura para el propósito del proceso, como activo fijo, insumo y etc. / MX Invoice type used to define process purpose, such as fixed asset, raw material and etc.','ImportInvoiceType','Y','N','N'),
					   ('3000',GETDATE(),'IMMEX','MX clave del pedimento de importación / MX Import customs declaration type','ImportPedimentoCode','Y','N','N'),
					   ...
					   ('3000',GETDATE(),'IMMEX','MX Tipo de Operación del Documento de Operacion para Despacho Aduanero (DODA) / MX Customs Clearance Operation Document Operation Type (DODA)','MXDODAOperationType','Y','N','N'),
					   ('3000',GETDATE(),'IMMEX','MX Régimen aduanero al que se destinan las mercancías del pedimento (Apéndice 16 del Anexo 22) / MX Customs regulations for goods in customs declaration (Appendix 16 from Annex 22)','PedimentoRegimen','Y','N','N'),

...
DECLARE @indexPrefix varchar(60) = 'IX_txdUSReconAdjustmentDetail_'
DECLARE @table varchar(60) = 'dbo.txdUSReconAdjustmentDetail'
DECLARE @indexColumns varchar(800) = 'PartnerID,LineGUID' --can include DESC

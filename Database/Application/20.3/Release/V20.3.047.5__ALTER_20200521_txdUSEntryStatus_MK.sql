...
DECLARE @indexPrefix varchar(60) = 'IX_txdUSEntryStatus_'
DECLARE @table varchar(60) = 'dbo.txdUSEntryStatus'
DECLARE @indexColumns varchar(800) = 'PartnerID,EntryNumber' --can include DESC

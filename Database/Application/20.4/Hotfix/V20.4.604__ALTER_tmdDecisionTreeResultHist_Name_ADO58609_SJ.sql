...
IF EXISTS (SELECT TOP 1 1 FROM sys.columns WHERE name = 'Name' --your column here
			AND Object_ID = OBJECT_ID('tmdDecisionTreeResultHist')) --Your Table Here
BEGIN
	...
	EXEC usp_DBACopyTableIndexesByColumn '','tmdDecisionTreeResultHist','Name','nvarchar',1,50

	ALTER TABLE tmdDecisionTreeResultHist --Your Table Here
	ALTER COLUMN Name [nvarchar] (50) NOT NULL --your column here

	--Do not change 1st paramter.  
	EXEC usp_DBACreateTableIndexes '','tmdDecisionTreeResultHist' --Your Table Here
END
...
BEGIN
	--Do not change 1st and 5th parameter.  
	--4th parameter is the updated data type; 6th paramter is the updated column length if any
	EXEC usp_DBACopyTableIndexesByColumn '','tmdDecisionTreeResultHist','Value','nvarchar',1,100

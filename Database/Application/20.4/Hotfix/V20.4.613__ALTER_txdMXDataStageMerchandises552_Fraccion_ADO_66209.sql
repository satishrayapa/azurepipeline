...
IF EXISTS (SELECT TOP 1 1 FROM sys.columns WHERE name = 'Fraccion' --your column here
			AND Object_ID = OBJECT_ID('txdMXDataStageMerchandises552')) --Your Table Here
BEGIN
	...
	EXEC usp_DBACopyTableIndexesByColumn '','txdMXDataStageMerchandises552','Fraccion','varchar',1,10

	ALTER TABLE txdMXDataStageMerchandises552 --Your Table Here
	ALTER COLUMN Fraccion [varchar] (10) NOT NULL --your column here

	--Do not change 1st paramter.  
	EXEC usp_DBACreateTableIndexes '','txdMXDataStageMerchandises552' --Your Table Here

...
BEGIN
	...
	EXEC usp_DBACopyTableIndexesByColumn '','txdMXSaaiDischarges','MXTariffNum','varchar',1,10
	...
	UPDATE txdMXSaaiDischarges SET MXTariffNum = REPLACE(STR(MXTariffNum,8),' ','0')
END

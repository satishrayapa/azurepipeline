...
IF EXISTS (SELECT TOP 1 1 FROM sys.columns WHERE name = 'AltHtsNum' --your column here
			AND Object_ID = OBJECT_ID('tmdMXHTSAudit')) --Your Table Here
BEGIN
	...
	EXEC usp_DBACopyTableIndexesByColumn '','tmdMXHTSAudit','AltHtsNum','varchar',1,12

	ALTER TABLE tmdMXHTSAudit --Your Table Here
	ALTER COLUMN AltHtsNum [varchar] (12) NOT NULL --your column here

	--Do not change 1st paramter.  
	EXEC usp_DBACreateTableIndexes '','tmdMXHTSAudit' --Your Table Here
END

...
IF EXISTS (SELECT TOP 1 1 FROM sys.columns WHERE name = 'Title' --your column here
			AND Object_ID = OBJECT_ID('tmdDecisionTreeHeader')) --Your Table Here
BEGIN
	...
	EXEC usp_DBACopyTableIndexesByColumn '','tmdDecisionTreeHeader','Title','nvarchar',1,50

	ALTER TABLE tmdDecisionTreeHeader --Your Table Here
	ALTER COLUMN Title [nvarchar] (50) NOT NULL --your column here

	--Do not change 1st paramter.  
	EXEC usp_DBACreateTableIndexes '','tmdDecisionTreeHeader' --Your Table Here
END
...
BEGIN
	--Do not change 1st and 5th parameter.  
	--4th parameter is the updated data type; 6th paramter is the updated column length if any
	EXEC usp_DBACopyTableIndexesByColumn '','tmdDecisionTreeHeader','Description','nvarchar',1,250
...
BEGIN
	--Do not change 1st and 5th parameter.  
	--4th parameter is the updated data type; 6th paramter is the updated column length if any
	EXEC usp_DBACopyTableIndexesByColumn '','tmdDecisionTreeHeader','Notes','nvarchar',1,250

IF EXISTS (select * from dbo.sysobjects where id = object_id(N'dbo.txdCNPTR3ReconcilePCAvePriceHist') 
...
ELSE
BEGIN
	CREATE TABLE [dbo].[txdCNPTR3ReconcilePCAvePriceHist] 
	(
		...
		ALTER TABLE [dbo].[txdCNPTR3ReconcilePCAvePriceHist] ADD CONSTRAINT [PK_txdCNPTR3ReconcilePCAvePriceHist] PRIMARY KEY NONCLUSTERED 
		(
		 [PartnerID] ASC
		,[DeclarationGUID] ASC

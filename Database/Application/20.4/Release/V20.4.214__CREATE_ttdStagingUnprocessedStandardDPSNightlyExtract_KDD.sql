IF EXISTS (
		SELECT TOP 1 1
		FROM sys.tables
		WHERE Name = 'ttdStagingUnprocessedStandardDPSNightlyExtract'
...
CREATE CLUSTERED INDEX [CIX_ttdStagingUnprocessedStandardDPSNightlyExtract] ON [dbo].[ttdStagingUnprocessedStandardDPSNightlyExtract] ([EffDate]) ON [PRIMARY]

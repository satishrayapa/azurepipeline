...
IF EXISTS (select TOP 1 1 from sys.tables where Name = 'txdFTZEntryTariffLineFeeHist' --Your Table Here
			AND Type = 'U')
BEGIN	
...
ELSE
BEGIN
	CREATE TABLE [dbo].[txdFTZEntryTariffLineFeeHist] --Your Table Here
	(
		...
		CREATE CLUSTERED INDEX [CIX_txdFTZEntryTariffLineFeeHist_1] ON [dbo].[txdFTZEntryTariffLineFeeHist] --Your Table Here
		(
			[EffDate] ASC
		)
		
		CREATE INDEX [IX_txdFTZEntryTariffLineFeeHist_1] ON [dbo].[txdFTZEntryTariffLineFeeHist] --Your Table Here
		(
			[PartnerID] ASC,
			[ExitDocID] ASC,
			[TariffLineNum] ASC
		...
		CREATE INDEX [IX_txdFTZEntryTariffLineFeeHist_2] ON [dbo].[txdFTZEntryTariffLineFeeHist] --Your Table Here
		(
			[PartnerID] ASC,
			[ExitDocID] ASC,
			[TariffLineNum] ASC,

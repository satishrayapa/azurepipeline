IF EXISTS (
		SELECT TOP 1 1
		FROM sys.tables
		WHERE Name = 'tmdFullStandardDPSExtractYesterday'			
		)
BEGIN
...
CREATE CLUSTERED INDEX [CIX_tmdFullStandardDPSExtractYesterday] ON [dbo].[tmdFullStandardDPSExtractYesterday] ([RegListID], [RegEntityID], [City]) ON [PRIMARY]

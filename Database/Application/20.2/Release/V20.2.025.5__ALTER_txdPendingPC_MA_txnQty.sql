...
IF EXISTS (SELECT TOP 1 1 FROM sys.columns WHERE name = 'txnQty' --your column here
			AND Object_ID = OBJECT_ID('txdPendingPC')) --Your Table Here
BEGIN
	...
	EXEC usp_DBACopyTableIndexesByColumn '','txdPendingPC','txnQty','numeric',1,0,38,19

	ALTER TABLE txdPendingPC --Your Table Here
	ALTER COLUMN txnQty [numeric](38,19) NOT NULL --your column here

	--Do not change 1st paramter.  
	EXEC usp_DBACreateTableIndexes '','txdPendingPC' --Your Table Here
END

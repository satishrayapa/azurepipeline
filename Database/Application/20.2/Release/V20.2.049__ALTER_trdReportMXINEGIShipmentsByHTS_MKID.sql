--select * from dbo.trdReportMXINEGIShipmentsByHTS
...
BEGIN
	CREATE TABLE [dbo].[trdReportMXINEGIShipmentsByHTS](
		...
		ALTER TABLE [dbo].[trdReportMXINEGIShipmentsByHTS] ADD CONSTRAINT [PK_trdReportMXINEGIShipmentsByHTS] PRIMARY KEY NONCLUSTERED --Your Table Here
		(
			  [PartnerID] ASC,
			  [EffDate] ASC,
			  [UserName] ASC

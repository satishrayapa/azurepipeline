...
--------------------------------------------------------------------------------------------------------------
IF EXISTS (select TOP 1 1 from sys.tables where Name = 'txdAdmissionReplaceInfoHist' --Your Table Here
			AND Type = 'U')
BEGIN	
...
ELSE
BEGIN
	CREATE TABLE [dbo].[txdAdmissionReplaceInfoHist] --Your Table Here
	(
		...
		CREATE CLUSTERED INDEX [CIX_txdAdmissionReplaceInfoHist] ON [dbo].[txdAdmissionReplaceInfoHist] --Your Table Here
		(
			[EffDate] ASC
		)

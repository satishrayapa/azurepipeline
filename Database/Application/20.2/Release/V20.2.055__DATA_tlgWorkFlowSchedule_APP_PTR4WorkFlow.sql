...
'Import CN Single Window PTR4 Response' as Description,
'N' AS Recurring, 
'1:00' AS Time,
GETDATE() AS Date,
...
WHERE
    NOT EXISTS (select * from tlgWorkFlowSchedule where PartnerID = PartnerID and Workflow = 'ImportCNSingleWindowPTR4Response')
